...
const DashboardLayout = () => {
    ...
    <>
      ...
      <li>
        <NavLink
          ...
          className="flex items-center gap-3"
        >
          <FaAddressCard /> Manage Candidates
        </NavLink>
      </li>
      <li>
        <NavLink
  ...
  const commonLinks = (
    <>
      ...
      <li>
        <NavLink to="/dashboard/add-story" className="flex items-center gap-3">
          <FaPlusSquare /> Add Story
        </NavLink>
      </li>
      <li>
        <NavLink
  ...
  return (
    <div className="drawer lg:drawer-open">
      ...
      <div className="drawer-content flex flex-col items-center justify-center p-4 md:p-8 bg-base-200">
        ...
        <label
          htmlFor="my-drawer-2"
          className="btn btn-primary drawer-button lg:hidden absolute top-4 right-4"
        >
          Menu
        </label>
      </div>
